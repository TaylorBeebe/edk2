  ...
  )
{
  ...
  HasPoolTail = !(NeedGuard && gMmMps.HeapGuardPolicy.Fields.Direction == HEAP_GUARD_ALIGNED_TO_TAIL);
  ...
  )
{
  ...
  HasPoolTail = !(MemoryGuarded && gMmMps.HeapGuardPolicy.Fields.Direction == HEAP_GUARD_ALIGNED_TO_TAIL);
