...
typedef struct {
  ...
  //   .UefiNonstopMode     : Enable UEFI non-stop mode. If enabled, UEFI will raise the debug flag
  ...
  //  .UefiNonstopMode       : Enable UEFI non-stop mode. If enabled, the debug flag will be raised
  //                           to break into debugger when a fault occurs.
