...
typedef union {
  UINT8    Data;
  struct {
    UINT8    MmNullDetection : 1;
    UINT8    MmNonstopMode   : 1;
  } Fields;
...
typedef struct {
  ...
  //
  //   .MmNullDetection      : Enable MM NULL detection.
  //   .MmNonstopMode        : Enable MM non-stop mode. If enabled, the debug flag will be raised
  ...
  //
  //  .MmPageGuard          : Enable MM page guard.
  //  .MmPoolGuard          : Enable MM pool guard.
  //  .MmNonstopMode        : Enable MM non-stop mode. If enabled, the debug flag will be raised
  //                          to break into debugger when a fault occurs.
...
#define MM_MEMORY_PROTECTION_SETTINGS_DEBUG                     \
          {                                                     \
            ...
            {                                                   \
              .Fields.MmNullDetection              = 1,         \
              .Fields.MmNonstopMode                = 1          \
            },                                                  \
            {                                                   \
