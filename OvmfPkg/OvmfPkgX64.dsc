...
!endif
  ...
  # QEMU S3 support allocates a buffer RWX and loads an image into it bypassing the dispatch
  # logic. This will need to be updated to apply image protections to the buffer, but for this
  # just remove S3 support.
