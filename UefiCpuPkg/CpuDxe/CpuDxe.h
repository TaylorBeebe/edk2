...
#define HEAP_GUARD_NONSTOP_MODE      (gDxeMps.HeapGuardPolicy.Fields.UefiNonstopMode == 1         &&  \
                                     (gDxeMps.HeapGuardPolicy.Fields.UefiPageGuard == 1           ||  \
                                      gDxeMps.HeapGuardPolicy.Fields.UefiPoolGuard == 1           ||  \
                                      gDxeMps.HeapGuardPolicy.Fields.UefiFreedMemoryGuard  == 1))     \

#define NULL_DETECTION_NONSTOP_MODE  (gDxeMps.NullPointerDetectionPolicy.Fields.UefiNullDetection == 1 && \
                                      gDxeMps.NullPointerDetectionPolicy.Fields.UefiNonstopMode == 1)
