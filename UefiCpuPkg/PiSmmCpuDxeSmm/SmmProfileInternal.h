...
#define HEAP_GUARD_NONSTOP_MODE      (gMmMps.HeapGuardPolicy.Fields.MmNonstopMode == 1  &&  \
                                     (gMmMps.HeapGuardPolicy.Fields.MmPageGuard == 1    ||  \
                                      gMmMps.HeapGuardPolicy.Fields.MmPoolGuard == 1))      \

#define NULL_DETECTION_NONSTOP_MODE  (gMmMps.NullPointerDetectionPolicy.Fields.MmNonstopMode == 1 && \
                                      gMmMps.NullPointerDetectionPolicy.Fields.MmNullDetection == 1)
